...
import { ReactiveBase, MultiRange, ReactiveList } from '../../app/app.js';
			...
			<div className="row">
				<div className="col s6 col-xs-6">
					<MultiRange
						...
						title="MultiRange"
						defaultSelected={config.MultiRange.defaultSelected}
						data={config.MultiRange.data}
						size={100}
					/>
				</div>
				<div className="col s6 col-xs-6">
...
export var MultiRangeTest = function() {
