...
var ReactiveElement = function (_Component) {
	...
	ReactiveElement.prototype.render = function render() {
		...
		return React.createElement(
			"div",
			{ className: "rbc-reactiveelement-container " + (this.props.className ? this.props.className : ""), style: this.props.style },
			React.createElement(
				"div",
				{ className: "rbc rbc-reactiveelement card thumbnail " + cx },
				title,
