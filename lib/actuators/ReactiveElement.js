...
var ReactiveElement = function (_Component) {
	...
	ReactiveElement.prototype.createChannel = function createChannel() {
		...
		var channelObj = manager.create(this.context.appbaseRef, this.context.type, react, this.props.size, this.props.from, this.props.stream, this.props.componentId);
