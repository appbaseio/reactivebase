...
var ReactiveList = function (_Component) {
		...
		function setScroll(node) {
			...
			if (node) {
				node.addEventListener("scroll", function () {
					...
					if (_this7.state.requestOnScroll && node.scrollTop + node.clientHeight >= node.scrollHeight && _this7.state.resultStats.total > _this7.state.currentData.length && !_this7.state.queryStart) {
						_this7.nextPage();
					}
				});
			}
	...
	ReactiveList.prototype.render = function render() {
		...
		return React.createElement(
			"div",
			{ className: "rbc-reactivelist-container", ref: function ref(node) {
					_this8.listContainer = node;
				} },
			React.createElement(
				"div",
				...
				React.createElement(
					"div",
					{ ref: function ref(node) {
							_this8.paginationAtBottom = node;
						} },
			...
			React.createElement(
				"div",
				{ ref: function ref(node) {
						_this8.poweredByContainer = node;
					}, style: { display: "none" } },
