...
var DataSearch = function (_Component) {
	...
	_createClass(DataSearch, [{
		...
		value: function highlightQuery() {
			...
			} else if (_isArray(highlightFields)) {
		...
		value: function render() {
			...
			return React.createElement(
				...
				title,
				this.props.autocomplete ? React.createElement(Select, _extends({
...
DataSearch.propTypes = {
	...
	highlightFields: React.PropTypes.oneOfType([React.PropTypes.string, React.PropTypes.arrayOf(React.PropTypes.string)])
};
