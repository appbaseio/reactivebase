...
var DataSearch = function (_Component) {
	...
	DataSearch.prototype.highlightQuery = function highlightQuery() {
		...
		} else if (_isArray(highlightField)) {
	...
	DataSearch.prototype.setData = function setData(data) {
		...
		var options = [];
		var appbaseField = _isArray(this.props.appbaseField) ? this.props.appbaseField : [this.props.appbaseField];
	...
	DataSearch.prototype.shouldQuery = function shouldQuery(value, fields) {
		var _this4 = this;

		var queries = [];
		fields.forEach(function (field, index) {
			var _match, _match_phrase_prefix;
			...
			var query = [{
				...
				match_phrase_prefix: (_match_phrase_prefix = {}, _match_phrase_prefix[field] = {
					query: value
				}, _match_phrase_prefix)
			}];
			if (_isArray(_this4.props.weights) && _this4.props.weights[index]) {
	...
	DataSearch.prototype.clearSuggestions = function clearSuggestions() {
		this.setState({
			options: []
		});
	};
	...
	DataSearch.prototype.render = function render() {
		...
		return React.createElement(
			...
			this.props.autoSuggest ? React.createElement(Autosuggest, {
				...
				React.createElement("span", { className: "rbc-search-icon" })
			)
		);
	};
