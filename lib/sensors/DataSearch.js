...
DataSearch.propTypes = {
	...
	dataField: PropTypes.oneOfType([PropTypes.string, PropTypes.arrayOf(PropTypes.string)]),
	...
	defaultSuggestions: PropTypes.arrayOf(PropTypes.shape({
	...
	fuzziness: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
