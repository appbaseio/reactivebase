...
var DataList = function (_Component) {
	...
	DataList.prototype.checkDefault = function checkDefault(props) {
		...
		if (props.multipleSelect && props.selectAllLabel === defaultValue[0] || !props.multipleSelect && props.selectAllLabel === defaultValue) {
			this.onSelectAll();
		} else {
			...
			if (this.props.multipleSelect) {
				...
				list = data.map(function (record, i) {
					return React.createElement(
						"div",
						{ className: "rbc-list-item row " + cx + " " + (selected && selected === record.value ? "rbc-list-item-active" : ""), key: record.label + "-" + i },
						React.createElement("input", {
							type: "checkbox",
							className: "rbc-checkbox-item",
							checked: selected && selected.indexOf(record.value) >= 0,
							onChange: function onChange() {
								return _this6.handleCheckboxChange(record);
							},
							id: record.label + "-" + i
						}),
						React.createElement(
							"label",
							{ className: "rbc-label", htmlFor: record.label + "-" + i },
							record.label
						)
					);
				});
				...
				list = data.map(function (record, i) {
					return React.createElement(
						"div",
						{ className: "rbc-list-item row " + _cx + " " + (selected && selected === record.value ? "rbc-list-item-active" : ""), key: record.label + "-" + i },
						React.createElement("input", {
							type: "radio",
		...
		if (data) {
			if (this.props.multipleSelect) {
				...
				list = data.map(function (record, i) {
					return React.createElement(
						"div",
						{ className: "rbc-list-item row " + cx + " " + (selected === record ? "rbc-list-item-active" : ""), key: record + "-" + i },
						React.createElement("input", {
							type: "checkbox",
							className: "rbc-checkbox-item",
						...
						React.createElement(
							"label",
							{ className: "rbc-label", htmlFor: record + "-" + i },
							record
						)
					);
				});
				...
				list = data.map(function (record, i) {
					return React.createElement(
						"div",
						{ className: "rbc-list-item row " + _cx2 + " " + (selected === record ? "rbc-list-item-active" : ""), key: record + "-" + i },
						React.createElement("input", {
							type: "radio",
							className: "rbc-radio-item",
	...
	DataList.prototype.getSelectAll = function getSelectAll(list) {
		...
		if (this.props.multipleSelect) {
			...
			selectAllItem = React.createElement(
				"div",
				{ className: "rbc-list-item row " + cx + " " + (this.state.selectAll ? "rbc-list-item-active" : ""), key: "select-all" },
				React.createElement("input", {
					type: "checkbox",
					className: "rbc-checkbox-item",
				...
				React.createElement(
					"label",
					{ className: "rbc-label", htmlFor: "select-all" },
			...
			selectAllItem = React.createElement(
				"div",
				{ className: "rbc-list-item row " + _cx3 + " " + (this.state.selectAll ? "rbc-list-item-active" : ""), key: "select-all" },
				React.createElement("input", {
					type: "radio",
					className: "rbc-radio-item",
					checked: this.state.selectAll,
