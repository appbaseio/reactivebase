...
var DataList = function (_Component) {
	...
	DataList.prototype.customQuery = function customQuery(record) {
		...
		if (this.state.selectAll) {
			...
			return _ref2 = {}, _ref2[this.type] = (_type = {}, _type[this.props.appbaseField] = record, _type), _ref2;
		}
		return null;
	};
	...
	DataList.prototype.reset = function reset() {
		...
		var execQuery = function execQuery() {
			if (_this5.props.onValueChange) {
				_this5.props.onValueChange(null);
			}

			helper.URLParams.update(_this5.props.componentId, null, _this5.props.URLParams);
			helper.selectedSensor.set(obj, true);
		};

		if (this.props.beforeValueChange) {
			this.props.beforeValueChange(value).then(function () {
				execQuery();
			}).catch(function (e) {
	...
	DataList.prototype.handleChange = function handleChange(record) {
		...
		this.setState({
			...
			_this6.defaultSelected = value;
			_this6.executeQuery(value);
		});
	};
	...
	DataList.prototype.handleCheckboxChange = function handleCheckboxChange(record) {
		...
		this.setState({
			...
			_this7.defaultSelected = selected;
			_this7.executeQuery(selected);
		});
	};
	...
	DataList.prototype.executeQuery = function executeQuery(value) {
		...
		var execQuery = function execQuery() {
			if (_this8.props.onValueChange) {
				if (_this8.state.selectAll) {
					_this8.props.onValueChange(_this8.props.data);
				} else {
					...
					return React.createElement(
						"div",
						{
							...
							onClick: function onClick() {
								_this9.handleCheckboxChange(record);
							} },
				...
				list = data.map(function (record, i) {
					return React.createElement(
						"div",
						{
							...
							key: record.label + "-" + i,
							onClick: function onClick() {
								return _this9.handleChange(record);
							} },
						React.createElement("input", {
							type: "radio",
		...
		if (this.props.multipleSelect) {
			if (this.state.selectAll) {
				...
				this.setState({
					...
					_this11.executeQuery(_this11.props.selectAllLabel);
				});
			}
		} else {
			this.setState({
