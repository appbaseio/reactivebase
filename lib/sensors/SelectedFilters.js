...
var SelectedFilters = function (_Component) {
	...
	SelectedFilters.prototype.render = function render() {
		...
		return Object.keys(this.state.filters).length ? React.createElement(
			"div",
			{ className: "rbc rbc-selectedfilters rbc-tag-container row card thumbnail " + (this.props.className ? this.props.className : ""), style: this.props.style },
			Object.keys(this.state.filters).map(function (item) {
				if (!_this3.props.blackList.includes(item)) {
					return React.createElement(
						"span",
						{ key: item, className: "rbc-tag-item col", title: _this3.parseValue(_this3.state.filters[item]) },
						React.createElement(
							"button",
