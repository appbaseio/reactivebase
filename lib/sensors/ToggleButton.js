	...
	ToggleButton.prototype.setQueryInfo = function setQueryInfo(props) {
		...
		var getQuery = function getQuery(value) {
			if (Array.isArray(value)) {
				var _currentQuery = props.customQuery ? props.customQuery(value) : _this5.customQuery(value);
				...
				_this5.previousQuery = _currentQuery;
...
ToggleButton.propTypes = {
	...
	defaultSelected: PropTypes.oneOfType([PropTypes.array, PropTypes.string]),
