...
var _ReactivePaginatedList = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/ReactivePaginatedList.md");
...
var _ReactivePaginatedList3 = require("./ReactivePaginatedList.stories");

var _ReactivePaginatedList4 = _interopRequireDefault(_ReactivePaginatedList3);
...
(0, _storybook.storiesOf)("ReactiveList", module).addDecorator(_storybookAddonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(_ReactiveList2.default, 3), function () {
	return _react2.default.createElement(_ReactiveList4.default, { onData: null, requestOnScroll: true, stream: false });
})).add("With Custom Markup", (0, _withReadme2.default)(removeFirstLine(_ReactiveList2.default, 3), function () {
	return _react2.default.createElement(_ReactiveList4.default, { requestOnScroll: true, stream: false });
})).add("Without Title", (0, _withReadme2.default)(removeFirstLine(_ReactiveList2.default, 3), function () {
	return _react2.default.createElement(_ReactiveList4.default, { title: "", requestOnScroll: true, stream: false });
...
(0, _storybook.storiesOf)("ReactivePaginatedList", module).addDecorator(_storybookAddonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(_ReactivePaginatedList2.default, 3), function () {
	return _react2.default.createElement(_ReactivePaginatedList4.default, {
		onData: null
	});
})).add("With Custom Markup", (0, _withReadme2.default)(removeFirstLine(_ReactivePaginatedList2.default, 3), function () {
	return _react2.default.createElement(_ReactivePaginatedList4.default, null);
})).add("With Sort Options", (0, _withReadme2.default)(removeFirstLine(_ReactivePaginatedList2.default, 3), function () {
	return _react2.default.createElement(_ReactivePaginatedList4.default, {
		sortOptions: [{
			label: "Most Recent RSVP",
			appbaseField: "mtime",
...
})).add("With Loader", (0, _withReadme2.default)(removeFirstLine(_ReactivePaginatedList2.default, 3), function () {
	return _react2.default.createElement(_ReactivePaginatedList4.default, {
		title: "Meetups",
		stream: false,
		initialLoader: "Loading results.."
	});
})).add("Playground", (0, _withReadme2.default)(removeFirstLine(_ReactivePaginatedList2.default, 3), function () {
	return _react2.default.createElement(_ReactivePaginatedList4.default, {
