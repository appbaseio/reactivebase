...
var _PaginatedReactiveList = require("./PaginatedReactiveList.stories");

var _PaginatedReactiveList2 = _interopRequireDefault(_PaginatedReactiveList);
...
(0, _storybook.storiesOf)("PaginatedReactiveList", module).addDecorator(_storybookAddonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(_PaginatedResultList2.default), function () {
	return _react2.default.createElement(_PaginatedReactiveList2.default, null);
})).add("Without on data", (0, _withReadme2.default)(removeFirstLine(_PaginatedResultList2.default), function () {
	return _react2.default.createElement(_PaginatedReactiveList2.default, {
		onData: null
	});
	...
	return _react2.default.createElement(_PaginatedReactiveList2.default, {
		title: (0, _storybookAddonKnobs.text)("title", "PaginatedReactiveList: Playground"),
		from: (0, _storybookAddonKnobs.number)("from", 0),
		size: (0, _storybookAddonKnobs.number)("size", 5),
