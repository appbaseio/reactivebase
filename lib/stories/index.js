...
var ReactiveElementReadme = _ResultList2.default;
...
})).add("Without histogram", (0, _withReadme2.default)(removeFirstLine(_RangeSlider4.default), function () {
	return _react2.default.createElement(_RangeSlider2.default, {
		showHistogram: false
	});
...
})).add("DefaultSelected", (0, _withReadme2.default)(removeFirstLine(_TextField4.default), function () {
	return _react2.default.createElement(_TextField2.default, { defaultSelected: "nissan" });
...
(0, _storybook.storiesOf)("DataController", module).addDecorator(_storybookAddonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(_DataSearch4.default), function () {
	return _react2.default.createElement(_DataController2.default, null);
})).add("With UI", (0, _withReadme2.default)(removeFirstLine(_DataSearch4.default), function () {
	...
	return _react2.default.createElement(_DataController2.default, {
		...
		queryLabel: (0, _storybookAddonKnobs.text)("queryLabel", "matchall"),
...
(0, _storybook.storiesOf)("ReactiveElement", module).addDecorator(_storybookAddonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(ReactiveElementReadme), function () {
	return _react2.default.createElement(_ReactiveElement2.default.Basic, null);
})).add("Stream", (0, _withReadme2.default)(removeFirstLine(ReactiveElementReadme), function () {
	return _react2.default.createElement(_ReactiveElement2.default.WithStream, null);
})).add("Theme", (0, _withReadme2.default)(removeFirstLine(ReactiveElementReadme), function () {
	return _react2.default.createElement(_ReactiveElement2.default.WithTheme, null);
})).add("Playground", (0, _withReadme2.default)(removeFirstLine(ReactiveElementReadme), function () {
	return _react2.default.createElement(_ReactiveElement2.default.Basic, {
		...
		initialLoader: (0, _storybookAddonKnobs.object)("initialLoader", {
			"show": true,
			"text": 'Loading initially.'
		}),
		noResults: (0, _storybookAddonKnobs.object)("noResults", {
			"show": true,
			"text": 'No Results Found!'
		}),
		resultStats: (0, _storybookAddonKnobs.object)("resultStats", {
			"show": true
		}),
...
})).add("With Title", (0, _withReadme2.default)(removeFirstLine(_ResultList2.default), function () {
	return _react2.default.createElement(_ReactiveList2.default, { title: "Meetups", requestOnScroll: true, stream: false });
})).add("With Streaming", (0, _withReadme2.default)(removeFirstLine(_ResultList2.default), function () {
...
})).add("Without on data", (0, _withReadme2.default)(removeFirstLine(_PaginatedResultList2.default), function () {
