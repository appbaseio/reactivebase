...
storiesOf("SingleDataList", module).addDecorator(withKnobs).add("Basic", function () {
...
}).add("With selectAllLabel", function () {
...
storiesOf("MultiDataList", module).addDecorator(withKnobs).add("Basic", function () {
...
storiesOf("SingleDropdownRange", module).addDecorator(withKnobs).add("Basic", withReadme(removeFirstLine(SingleDropdownRangeReadme), function () {
	...
	return React.createElement(SingleDropdownRangeDefault, { title: text("title", "SingleDropdownRange: Price Filter") });
})).add("With placeholder", withReadme(removeFirstLine(SingleDropdownRangeReadme), function () {
	return React.createElement(SingleDropdownRangeDefault, { placeholder: text("placeholder", "Search prices") });
})).add("With Default Selected", withReadme(removeFirstLine(SingleDropdownRangeReadme), function () {
	return React.createElement(SingleDropdownRangeDefault, { defaultSelected: text("defaultSelected", "Cheap") });
})).add("With URLParams", withReadme(removeFirstLine(SingleDropdownRangeReadme), function () {
	return React.createElement(SingleDropdownRangeDefault, { URLParams: boolean("URLParams (not visible on storybook)", true) });
...
storiesOf("MultiDropdownRange", module).addDecorator(withKnobs).add("Basic", withReadme(removeFirstLine(MultiDropdownRangeReadme), function () {
	...
	return React.createElement(MultiDropdownRangeDefault, { title: text("title", "SingleDropdownRange: Price Filter") });
})).add("With placeholder", withReadme(removeFirstLine(SingleDropdownRangeReadme), function () {
	return React.createElement(MultiDropdownRangeDefault, { placeholder: text("placeholder", "Search prices") });
})).add("With Default Selected", withReadme(removeFirstLine(MultiDropdownRangeReadme), function () {
	return React.createElement(MultiDropdownRangeDefault, { defaultSelected: array("defaultSelected", ["Cheap", "Moderate"]) });
})).add("With URLParams", withReadme(removeFirstLine(MultiDropdownRangeReadme), function () {
	return React.createElement(MultiDropdownRangeDefault, { URLParams: boolean("URLParams (not visible on storybook)", true) });
