...
})).add("Without Radio", withReadme(removeFirstLine(SingleListReadme), function () {
	return React.createElement(SingleListDefault, { showSearch: true, defaultSelected: "San Francisco", showRadio: false, placeholder: "Search City" });
...
})).add("With filterLabel", withReadme(removeFirstLine(SingleListReadme), function () {
	return React.createElement(SingleListDefault, { showSearch: true, selectAllLabel: "All Cities", filterLabel: "Custom Filter Name", placeholder: "Search City" });
...
storiesOf("MultiList", module).addDecorator(withKnobs).add("Basic", withReadme(removeFirstLine(MultiListReadme), function () {
	...
	return React.createElement(MultiListDefault, { showSearch: true, defaultSelected: ["London", "Sydney"], showCheckbox: false, placeholder: "Search City" });
...
})).add("With queryFormat as and", withReadme(removeFirstLine(MultiListReadme), function () {
	return React.createElement(MultiListDefault, { showSearch: true, queryFormat: "and", placeholder: "Search City" });
})).add("With queryFormat as or", withReadme(removeFirstLine(MultiListReadme), function () {
	return React.createElement(MultiListDefault, { showSearch: true, queryFormat: "or", placeholder: "Search City" });
})).add("With filterLabel", withReadme(removeFirstLine(MultiListReadme), function () {
	return React.createElement(MultiListDefault, { showSearch: true, queryFormat: "or", placeholder: "Search City", filterLabel: "Custom Filter Name" });
...
})).add("With filterLabel", withReadme(removeFirstLine(SingleDropdownListReadme), function () {
	return React.createElement(SingleDropdownListDefault, {
		selectAllLabel: "All Cities",
		defaultSelected: "London",
...
})).add("With queryFormat as and", withReadme(removeFirstLine(MultiDropdownListReadme), function () {
	return React.createElement(MultiDropdownListDefault, {
		placeholder: "Select Cities",
		size: 100,
		sortBy: "count",
...
})).add("With queryFormat as or", withReadme(removeFirstLine(MultiDropdownListReadme), function () {
	return React.createElement(MultiDropdownListDefault, {
		placeholder: "Select Cities",
		size: 100,
		sortBy: "count",
...
})).add("With filterLabel", withReadme(removeFirstLine(MultiDropdownListReadme), function () {
	return React.createElement(MultiDropdownListDefault, {
		placeholder: "Select Cities",
		size: 100,
		sortBy: "count",
...
storiesOf("SingleDataList", module).add("Basic", function () {
	return React.createElement(SingleDataListDefault, null);
}).add("With defaultSelected", function () {
	return React.createElement(SingleDataListDefault, { defaultSelected: "Social" });
}).add("Without Radio", function () {
	return React.createElement(SingleDataListDefault, { showRadio: false });
}).add("With filterLabel", function () {
	return React.createElement(SingleDataListDefault, { defaultSelected: "Social", filterLabel: "Custom Filter Name" });
});

storiesOf("MultiDataList", module).add("Basic", function () {
	return React.createElement(MultiDataListDefault, null);
}).add("With defaultSelected", function () {
	return React.createElement(MultiDataListDefault, { defaultSelected: ["Social", "Travel"] });
}).add("Without Checkbox", function () {
	return React.createElement(MultiDataListDefault, { showCheckbox: false });
}).add("With filterLabel", function () {
	return React.createElement(MultiDataListDefault, { defaultSelected: ["Social", "Travel"], filterLabel: "Custom Filter Name" });
});
...
})).add("Without Radio", withReadme(removeFirstLine(SingleRangeReadme), function () {
	return React.createElement(SingleRangeDefault, { showRadio: false });
})).add("With filterLabel", withReadme(removeFirstLine(SingleRangeReadme), function () {
	return React.createElement(SingleRangeDefault, { filterLabel: "Custom Filter Name" });
...
storiesOf("MultiRange", module).addDecorator(withKnobs).add("Basic", withReadme(removeFirstLine(MultiRangeReadme), function () {
	...
	return React.createElement(MultiRangeDefault, { showCheckbox: false });
})).add("With filterLabel", withReadme(removeFirstLine(MultiRangeReadme), function () {
	return React.createElement(MultiRangeDefault, { filterLabel: "Custom Filter Name" });
...
storiesOf("SingleDropdownRange", module).addDecorator(withKnobs).add("Basic", withReadme(removeFirstLine(SingleDropdownRangeReadme), function () {
	...
	return React.createElement(SingleDropdownRangeDefault, { defaultSelected: "Cheap", filterLabel: "Custom Filter Name" });
...
storiesOf("MultiDropdownRange", module).addDecorator(withKnobs).add("Basic", withReadme(removeFirstLine(MultiDropdownRangeReadme), function () {
	...
	return React.createElement(MultiDropdownRangeDefault, { defaultSelected: ["Cheap", "Moderate"], filterLabel: "Custom Filter Name" });
...
})).add("With filterLabel", withReadme(removeFirstLine(NumberBoxReadme), function () {
	return React.createElement(NumberBoxDefault, {
		data: {
			label: "Car Ratings",
			start: 1,
...
})).add("With filterLabel", withReadme(removeFirstLine(ToggleButtonReadme), function () {
	return React.createElement(ToggleButtonDefault, { defaultSelected: ["Social"], filterLabel: "Custom Filter Name" });
...
})).add("With filterLabel", withReadme(removeFirstLine(TextFieldReadme), function () {
	return React.createElement(TextFieldDefault, { defaultSelected: "nissan", filterLabel: "Custom Filter Name" });
...
})).add("With Weights", withReadme(removeFirstLine(DataSearchReadme), function () {
	return React.createElement(DataSearchDefault, {
		title: "DataSearch",
		placeholder: "Search Venue",
		weights: [1, 3]
	});
})).add("With filterLabel", withReadme(removeFirstLine(DataSearchReadme), function () {
	return React.createElement(DataSearchDefault, {
		title: "DataSearch",
		placeholder: "Search Venue",
		weights: [1, 3],
...
})).add("With filterLabel", withReadme(removeFirstLine(DataControllerReadme), function () {
	return React.createElement(DataControllerDefault, {
		title: "DataController",
		visible: true,
		dataLabel: React.createElement(
...
})).add("With filterLabel", withReadme(removeFirstLine(DatePickerReadme), function () {
	return React.createElement(DatePickerDefault, {
		allowAllDates: false,
		filterLabel: "Custom Filter Name"
	});
...
})).add("With filterLabel", withReadme(removeFirstLine(DateRangeReadme), function () {
	return React.createElement(DateRangeDefault, {
		allowAllDates: false,
		filterLabel: "Custom Filter Name"
	});
...
})).add("With pages", withReadme(removeFirstLine(ReactiveListReadme, 3), function () {
	return React.createElement(ReactiveListDefault, { pagination: true, paginationAt: "top", title: "Meetups", pages: number("pages", 9) });
