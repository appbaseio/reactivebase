...
var MultiRangeDefault = function (_Component) {
	...
	function MultiRangeDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (MultiRangeDefault.__proto__ || Object.getPrototypeOf(MultiRangeDefault)).call(this, props));

		_this.onAllData = _this.onAllData.bind(_this);
		return _this;
	}

	_createClass(MultiRangeDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.MultiRange, _extends({
...
exports.default = MultiRangeDefault;
