...
var MultiDropdownRangeDefault = function (_Component) {
	...
	function MultiDropdownRangeDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (MultiDropdownRangeDefault.__proto__ || Object.getPrototypeOf(MultiDropdownRangeDefault)).call(this, props));

		_this.onData = _this.onData.bind(_this);
		return _this;
	}

	_createClass(MultiDropdownRangeDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.MultiDropdownRange, _extends({
...
exports.default = MultiDropdownRangeDefault;
