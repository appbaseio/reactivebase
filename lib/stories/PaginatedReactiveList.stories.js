...
var PaginatedReactiveListDefault = function (_Component) {
	_inherits(PaginatedReactiveListDefault, _Component);

	function PaginatedReactiveListDefault(props) {
		_classCallCheck(this, PaginatedReactiveListDefault);

		var _this = _possibleConstructorReturn(this, (PaginatedReactiveListDefault.__proto__ || Object.getPrototypeOf(PaginatedReactiveListDefault)).call(this, props));
	...
	_createClass(PaginatedReactiveListDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.PaginatedReactiveList, _extends({
	...
	return PaginatedReactiveListDefault;
}(_react.Component);

exports.default = PaginatedReactiveListDefault;
