...
var WithStream = function (_Component) {
	...
	function WithStream(props) {
		...
		var _this = _possibleConstructorReturn(this, (WithStream.__proto__ || Object.getPrototypeOf(WithStream)).call(this, props));
	...
	_createClass(WithStream, [{
		...
		value: function onAllData(res, err) {
			...
			if (res && res.appliedQuery) {
				...
				if (combineData) {
					combineData = (0, _helper2.GetTopTopics)(combineData);
