...
var WithStream = function (_Component) {
	_inherits(WithStream, _Component);

	function WithStream(props) {
		_classCallCheck(this, WithStream);
	...
	WithStream.prototype.cityQuery = function cityQuery(value) {
		if (value) {
	...
	WithStream.prototype.componentDidMount = function componentDidMount() {
		ResponsiveStory();
	};

	WithStream.prototype.onAllData = function onAllData(res, err) {
		var _this2 = this;
		...
		if (res && res.appliedQuery) {
			...
			if (combineData) {
				...
				result = React.createElement(
					"div",
					{ className: "trendingTopics col s12 col-xs-12", style: { padding: "10px", paddingBottom: "60px" } },
					React.createElement(
						"table",
						{ className: "table" },
						React.createElement(
	...
	WithStream.prototype.itemMarkup = function itemMarkup(data, index) {
	...
	WithStream.prototype.render = function render() {
		return React.createElement(
			ReactiveBase,
			{
				app: "meetup2",
