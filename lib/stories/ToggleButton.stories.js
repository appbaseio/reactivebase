...
var ToggleButtonDefault = function (_Component) {
	...
	function ToggleButtonDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (ToggleButtonDefault.__proto__ || Object.getPrototypeOf(ToggleButtonDefault)).call(this, props));
	...
	_createClass(ToggleButtonDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.ToggleButton, _extends({
...
exports.default = ToggleButtonDefault;
