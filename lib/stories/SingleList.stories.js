...
var SingleListDefault = function (_Component) {
	...
	function SingleListDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (SingleListDefault.__proto__ || Object.getPrototypeOf(SingleListDefault)).call(this, props));

		_this.DEFAULT_IMAGE = "http://www.avidog.com/wp-content/uploads/2015/01/BellaHead082712_11-50x65.jpg";
		return _this;
	}

	_createClass(SingleListDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.SingleList, _extends({
					...
					_react2.default.createElement(
						"div",
						{ className: "col s6 col-xs-6" },
						_react2.default.createElement(_app.ReactiveList, (_React$createElement = {
							...
							from: 0,
							size: 20
						}, _defineProperty(_React$createElement, "size", 2), _defineProperty(_React$createElement, "onData", this.onData), _defineProperty(_React$createElement, "react", {
							and: ["CitySensor"]
...
exports.default = SingleListDefault;
