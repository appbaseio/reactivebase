...
var MultiDataListDefault = function (_Component) {
	...
	function MultiDataListDefault(props) {
		...
		_this.data = ["Social", "Travel", "Outdoors"];

		_this.DEFAULT_IMAGE = "http://www.avidog.com/wp-content/uploads/2015/01/BellaHead082712_11-50x65.jpg";
		return _this;
	}

	MultiDataListDefault.prototype.componentDidMount = function componentDidMount() {
		ResponsiveStory();
	};

	MultiDataListDefault.prototype.onData = function onData(markerData) {
	...
	MultiDataListDefault.prototype.render = function render() {
		return React.createElement(
			ReactiveBase,
			{
				app: "meetup_demo",
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(MultiDataList, _extends({
...
export default MultiDataListDefault;
