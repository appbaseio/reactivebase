...
var SingleDataListDefault = function (_Component) {
	_inherits(SingleDataListDefault, _Component);

	function SingleDataListDefault(props) {
		_classCallCheck(this, SingleDataListDefault);
	...
	SingleDataListDefault.prototype.componentDidMount = function componentDidMount() {
		ResponsiveStory();
	};

	SingleDataListDefault.prototype.onData = function onData(markerData) {
	...
	SingleDataListDefault.prototype.render = function render() {
		return React.createElement(
			ReactiveBase,
			{
				app: "meetup_demo",
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(SingleDataList, _extends({
	...
	return SingleDataListDefault;
}(Component);

export default SingleDataListDefault;


SingleDataListDefault.defaultProps = {
	mapping: {
