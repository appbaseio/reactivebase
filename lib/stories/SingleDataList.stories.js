...
var SingleDataListDefault = function (_Component) {
	...
	function SingleDataListDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (SingleDataListDefault.__proto__ || Object.getPrototypeOf(SingleDataListDefault)).call(this, props));
	...
	_createClass(SingleDataListDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.SingleDataList, _extends({
...
exports.default = SingleDataListDefault;
