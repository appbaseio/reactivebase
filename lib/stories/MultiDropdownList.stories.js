...
var MultiDropdownListDefault = function (_Component) {
	_inherits(MultiDropdownListDefault, _Component);

	function MultiDropdownListDefault(props) {
		_classCallCheck(this, MultiDropdownListDefault);
	...
	MultiDropdownListDefault.prototype.componentDidMount = function componentDidMount() {
		ResponsiveStory();
	};

	MultiDropdownListDefault.prototype.onData = function onData(markerData) {
	...
	MultiDropdownListDefault.prototype.render = function render() {
		return React.createElement(
			ReactiveBase,
			{
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(MultiDropdownList, _extends({
	...
	return MultiDropdownListDefault;
}(Component);

export default MultiDropdownListDefault;
