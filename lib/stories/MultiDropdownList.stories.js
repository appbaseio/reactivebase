...
var MultiDropdownListDefault = function (_Component) {
	...
	function MultiDropdownListDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (MultiDropdownListDefault.__proto__ || Object.getPrototypeOf(MultiDropdownListDefault)).call(this, props));

		_this.DEFAULT_IMAGE = "http://www.avidog.com/wp-content/uploads/2015/01/BellaHead082712_11-50x65.jpg";
		return _this;
	}

	_createClass(MultiDropdownListDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.MultiDropdownList, _extends({
...
exports.default = MultiDropdownListDefault;
