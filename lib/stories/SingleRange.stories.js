...
var SingleRangeDefault = function (_Component) {
	...
	function SingleRangeDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (SingleRangeDefault.__proto__ || Object.getPrototypeOf(SingleRangeDefault)).call(this, props));

		_this.onData = _this.onData.bind(_this);
		return _this;
	}

	_createClass(SingleRangeDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.SingleRange, _extends({
...
exports.default = SingleRangeDefault;
