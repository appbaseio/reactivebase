...
var SingleRangeDefault = function (_Component) {
	_inherits(SingleRangeDefault, _Component);

	function SingleRangeDefault(props) {
		_classCallCheck(this, SingleRangeDefault);

		return _possibleConstructorReturn(this, _Component.call(this, props));
	}

	SingleRangeDefault.prototype.componentDidMount = function componentDidMount() {
		ResponsiveStory();
	};

	SingleRangeDefault.prototype.onData = function onData(markerData) {
	...
	SingleRangeDefault.prototype.render = function render() {
		return React.createElement(
			ReactiveBase,
			{
				app: "car-store",
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(SingleRange, _extends({
	...
	return SingleRangeDefault;
}(Component);

export default SingleRangeDefault;
