...
var RangeSliderDefault = function (_Component) {
	...
	function RangeSliderDefault(props) {
		...
		var _this = _possibleConstructorReturn(this, (RangeSliderDefault.__proto__ || Object.getPrototypeOf(RangeSliderDefault)).call(this, props));

		_this.DEFAULT_IMAGE = "http://www.avidog.com/wp-content/uploads/2015/01/BellaHead082712_11-50x65.jpg";
		return _this;
	}

	_createClass(RangeSliderDefault, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_app.RangeSlider, _extends({
...
exports.default = RangeSliderDefault;
